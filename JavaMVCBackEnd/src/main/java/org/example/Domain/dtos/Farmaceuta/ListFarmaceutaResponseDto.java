...
public class ListFarmaceutaResponseDto {
    ...
    public List<FarmaceutaResponseDto> getFarmaceutas() { return farmaceutas; }
    public void setFarmaceutas(List<FarmaceutaResponseDto> farmaceutas) { this.farmaceutas = farmaceutas; }
}
